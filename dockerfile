...
RUN wget https://gitlab.com/german.tischler/libmaus2/-/archive/2.0.750-release-20200903115526/libmaus2-2.0.750-release-20200903115526.tar.bz2 \
	...
	&& cd ${SOFT}/tar-libmaus2/libmaus2_2.0.750-release-20200903115526 \
...
#	&& git pull https://gitlab.com/grman.tischler/libmaus2.git e8f60a3759a5134bf35ddcc659337d74324efc7f \
#	&& mkdir ${SOFT}/libmaus2_2.0.750 \
#	&& libtoollze \
#	&& aclocal \
#	&& autoreconf -i -f \
